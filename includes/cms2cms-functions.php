...
class CmsPluginFunctionsConcrete5
{
    ...
    const CMS2CMS_OPTION_TABLE = 'cms2cms_concrete5_options';
    ...
    {
        $cms2cms_concrete5_access_login = $this->getOption('cms2cms-concrete5-login');
        $cms2cms_concrete5_access_key = $this->getOption('cms2cms-concrete5-key');
    ...
    {
        $key = $this->getOption('cms2cms-concrete5-key');
        $login = $this->getOption('cms2cms-concrete5-login');
    ...
    public function saveOptions()
    {
        ...
        $cms2cms_concrete5_site_url = $this->getSiteUrl();
        $bridge_depth = str_replace($cms2cms_concrete5_site_url, '', $this->getFrontUrl());
        ...
        if ( $key && $login ) {
            $this->deleteOption('cms2cms-concrete5-key');
            $this->setOption('cms2cms-concrete5-key', $key);

            $this->deleteOption('cms2cms-concrete5-login');
            $this->setOption('cms2cms-concrete5-login', $login);

            $this->deleteOption('cms2cms-concrete5-depth');
            $this->setOption('cms2cms-concrete5-depth', $bridge_depth);
